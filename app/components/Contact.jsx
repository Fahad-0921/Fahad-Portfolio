...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "3ac82e75-70b8-43d8-a28d-4a7cb53b86e4");
  ...
  transition={{ delay: 0.7, duration: 0.5 }} 
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>Have a project in mind or need assistance?
        I'm here to help bring your ideas to life.
        Feel free to reach out,  I’m just a message away—let’s connect and get started!</motion.p>
